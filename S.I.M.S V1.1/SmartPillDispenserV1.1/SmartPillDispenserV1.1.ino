...
const unsigned long lcdInterval = 400; // Faster updates for smoother animation

// Smooth scrolling variables
String upcomingText = "";
int scrollPosition = 0;
unsigned long lastScrollUpdate = 0;
const unsigned long scrollInterval = 150; // Smoother scrolling speed
